...
function Home(){
    return (
        <>
            ...
            <p>This is Sean, a 19 year old computer science student who sells goods at criminally low prices! His secret: theft! Sean and his team steal the items on this store from warehouses across the world, allowing 100% profits and low prices for everyone! It truly is a win-win!</p>
        </>
    );
}
